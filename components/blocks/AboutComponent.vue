<template>
  <div class="about main__content margin-bottom-xl">
    ...
    <p class="main__content-intro max-width-xxs">
      ...
      <br /><br />
      <br /><br />
      Auratyk is a project to create space with sound.
    </p>
  </div>
  <!-- <div class="sticky-sharebar js-sticky-sharebar">
      <ul class="sticky-sharebar__list">
        <li>
          <a
            class="sticky-sharebar__btn js-social-share"
            data-social="twitter"
            data-text="Hi there! https://codyhouse.co via @CodyWebHouse"
            data-hashtags="#nuggets, #dev"
        ...
        <li>
          <a
            ...
            data-description="Description for my Pinterest share"
            data-media="https://codyhouse.co/app/assets/img/social-sharing-img-1.jpg"
