    ...
    <div class="footer-v3__container container max-width-lg">
      ...
      <nav class="footer-v3__nav">
        <ul class="footer-v3__nav-list">
          <li class="footer-v3__nav-item"><a href="/about">About</a></li>
          <li class="footer-v3__nav-item"><a href="/contact">Contact</a></li>
          <li class="footer-v3__nav-item">
            <a href="/privacy-policy">Privacy</a>
          </li>
          <!-- <li class="footer-v3__nav-item"><a href="#0">Company</a></li> -->
        </ul>
      </nav>
      ...
      <!-- <div class="footer-v3__socials">
        ...
        <a href="#0">
          <svg class="icon" viewBox="0 0 16 16">
            <title>Follow us on Soundcloud</title>
            <g>
              <path
